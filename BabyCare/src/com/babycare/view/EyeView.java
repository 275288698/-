...
public class EyeView extends FrameLayout {
    ...
    public void setRadius(int radius) {
        ...
        Log.e("^^^^^^^^^", " radius^^^  "+radius+ "  getWidth()= "+ getWidth()+"   "+getHeight());
//        canvas.drawOval(new RectF(0, 0, radius, radius*getWidth()/getHeight()), paint);
        canvas.drawCircle(getWidth() / 2f, getHeight() / 2f, radius*2.75f, paint);
        invalidate();
    }
