package com.babycare.adapter.holder;
...
public class CommViewHolder {
     ...
     * @return 
     */  
//    public CommViewHolder setImageViewByUrl(ImageView imgView, String url)
//    {  
//        BaseApplication.imageLoader.displayImage(url, imgView, BaseApplication.options);
//        
//        return this;  
//    }  
...
//    {  
//        BaseApplication.imageLoader.displayImage(url, (ImageView) getView(viewId), BaseApplication.options);
//        return this;  
//    }  
    /** 
     * 为ImageView设置图片 防止listview滑动时图片闪动
     *  
     * @param viewId 
     * @param url 
     * @return 
     */  
//    public CommViewHolder setImageByUrlLoadImage(int viewId, String url)  
//    {  
//        final ImageView imageView = getView(viewId);
//        BaseApplication.imageLoader.loadImage(url, new SimpleImageLoadingListener(){
//        	@Override
