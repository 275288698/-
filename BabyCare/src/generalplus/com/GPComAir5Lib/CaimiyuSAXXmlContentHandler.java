...
public class CaimiyuSAXXmlContentHandler extends DefaultHandler {  
  
	    private ArrayList<CaimiyuPerson> persons;  
	    private CaimiyuPerson person;  
	    private String tagName; //当前标记  

	    public ArrayList<CaimiyuPerson> getBookscaimiyu() {  
	    	return persons;  
	    ...
	    public void startDocument() throws SAXException {  
	        this.persons = new ArrayList<CaimiyuPerson>();  
