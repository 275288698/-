...
public class Shezhi extends Activity {
	...
	if(globe.x==1){	
		Shezhi.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
	}
	if(globe.x==2){
		Shezhi.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
	}
...
//					startActivity(intent);
					break;	
				case R.id.ganshou:
					Intent intent1 = new Intent(Shezhi.this,Fankui.class);
					startActivity(intent1);
					break;
				case R.id.xinxi:
					Intent intent2 = new Intent(Shezhi.this,Xinxi.class);
					startActivity(intent2);
					break;		
				case R.id.bangzhu:
					Intent intent3 = new Intent(Shezhi.this,Bangzhu.class);
					startActivity(intent3);
					break;
				case R.id.kongzhi:
					Intent intent4 = new Intent(Shezhi.this,Leixing.class);
